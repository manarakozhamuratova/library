...
// Create mocks base method.
func (m *MockITransactionRepository) Create(ctx context.Context, tr *model.Transaction) error {
	m.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockITransactionRepositoryMockRecorder) Create(ctx, tr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockITransactionRepository)(nil).Create), ctx, tr)
}
